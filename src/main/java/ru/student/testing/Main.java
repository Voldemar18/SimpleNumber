...
/*
* консольное приложение, которое генерирует случайную последовательность чисел от 1 до n (где n - число введенное с клавиатуры) и проверяет, содержит ли она хотя бы одно простое число
        Например, пользователь вводит 5, в консоли отображается случайная последовательность "1,2,3,4,5" и "Простые числа в последовательности: 2, 3, 5"
 */
public class Main {
